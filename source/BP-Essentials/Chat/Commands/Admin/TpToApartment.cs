        ...
        public static void Run(SvPlayer player, string message)
        {
            ...
            switch (arg1)
            {
                ...
                case "1000":
                    ...
                    player.SendToSelf(Channel.Unsequenced, ClPacket.GameMessage, $"<color={infoColor}>Teleported to 1.2k apartment.</color>");
                    break;
                case "5k":
                case "2":
                case "5000":
                    player.SvReset(new Vector3(518.8F, 0, -127.2F), Quaternion.identity, 0);
                    player.SendToSelf(Channel.Unsequenced, ClPacket.GameMessage, $"<color={infoColor}>Teleported to 5k apartment.</color>");
                    break;
                case "10k":
                case "10":
                case "3":
                case "10000":
                    ...
                    player.SendToSelf(Channel.Unsequenced, ClPacket.GameMessage, $"<color={infoColor}>Teleported to 10k apartment.</color>");
                    break;
                default:
