...
function(a, b, c) {
    function d(a) {
        var c, d = [], e = b, f = e.documentElement.doScroll, g = "DOMContentLoaded", h = (f ? /^loaded|^c/ : /^loaded|^i|^c/).test(e.readyState);
        h || e.addEventListener(g, c = function() {
            for (e.removeEventListener(g, c),
            h = 1; c = d.shift(); )
                c()
        }
        ),
    ...
    function e() {
        ...
        Array.prototype.forEach.call(e, function(e) {
            ...
            c = e.nextElementSibling ? !e.nextElementSibling.classList.contains("sr-only") : !0,
            a && c && (d = b.createElement("span"),
            d.innerHTML = a,
