...
* https://www.userr00t.com/dev/BPEssentials/idlist_items.txt - IDList for ``/give``.
* https://www.userr00t.com/dev/BPEssentials/idlist_vehicles.txt - IDList for ``/vehicle``.
